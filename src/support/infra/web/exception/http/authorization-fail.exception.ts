...
export class AuthorizationFailException extends UnauthorizedException {
    constructor(
        public readonly datasource: any,
        public readonly reason: any | null = null,
        getResponseMessage: (
            defaultMessage: ErrorMessage<'AuthorizationFail'>,
        ) => string = (msg) => msg,
    ) {
        const response: any = Errors.of('AuthorizationFail')
